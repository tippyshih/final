...
<body>
    ...
    <div class="container justify-content-center"> <button class="navbar-toggler navbar-toggler-right border-0" type="button" data-toggle="collapse" data-target="#navbar3">
      ...
      <div class="collapse navbar-collapse text-center justify-content-center" id="navbar3">
        <ul class="navbar-nav">
          ...
          <li class="nav-item mx-2" style=""> <a class="nav-link" href="#">玩過的手遊</a> </li>
          <li class="nav-item mx-2"> <a class="nav-link" href="#">已參加的公會</a> </li>
        </ul>
      </div>
    </div>
  </nav>
      ...
      <div class="row" style="">
        <div class="col-md-3" style="">
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="row">
                <div class="col-md-12"><a href="#" class="list-group-item list-group-item-action" id="GAME!">GAME1</a></div>
              </div><a href="#" class="list-group-item list-group-item-action" style="">GAME2</a><a href="#" class="list-group-item list-group-item-action">GAME3</a>
            </div>
          </div>
        </div>
              ...
              <div class="row">
                <div class="col-md-12" style="">
                  <div class="list-group">
                    <meta http-equiv="”refresh”" content="”3″"> <a href="#" class="list-group-item list-group-item-action flex-column align-items-start active">
                      <div class="d-flex w-100 justify-content-between">
                        <h5 class="mb-1" contenteditable="true">玩過的遊戲</h5>
                      </div>
                    </a>
                    ...
                    </a><a href="#" class="list-group-item list-group-item-action flex-column align-items-start" style="">
                      <div class="d-flex w-100 justify-content-between">
                        <h5 class="mb-1">List group </h5> <small class="text-muted">3 days ago</small>
                      </div>
                    </a><a href="#" class="list-group-item list-group-item-action flex-column align-items-start" style="">
        ...
        <div class="col-md-4" style="">
          <div class="row">
            <div class="col-md-12" style="">
              <div class="row">
                <div class="col-md-12"><a class="btn btn-lg text-dark btn-primary text-capitalize text-nowrap w-50" href="#">交友邀請</a></div>
              </div>
              <div class="row">
                <div class="col-md-12">
                  <div class="row">
  ...
  <div class="py-5 text-center text-white align-items-center d-flex h-25" style="background-image: linear-gradient(to bottom, rgba(0, 0, 0, .75), rgba(0, 0, 0, .75)), url(https://static.pingendo.com/cover-bubble-dark.svg);  background-position: center center, center center;  background-size: cover, cover;  background-repeat: repeat, repeat;"></div>
